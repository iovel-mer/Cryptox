...
export const Trading: React.FC = () => {
  ...
  return (
    <section className="relative  mx-auto border-b-2 border-gray-200 py-16 px-4  overflow-hidden min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800">
