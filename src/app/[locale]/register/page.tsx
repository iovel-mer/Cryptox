  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 flex flex-col lg:flex-row relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-8 overflow-y-auto relative z-10">
        <Card className="w-full max-w-md bg-gradient-to-br from-gray-900/60 to-black/60 backdrop-blur-xl border-2 border-amber-400/30 text-white shadow-2xl shadow-amber-500/20 rounded-2xl">
          <CardHeader className="pb-4">
            <Link href={`/${locale}`} className="inline-flex items-center text-amber-300 hover:text-white mb-4 transition-colors font-mono">
            ...
            <p className="text-amber-200 text-center font-mono">{t("subtitle")}</p>
          </CardHeader>
          <CardContent>
            {error && (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="firstName" className="text-amber-200 font-mono uppercase tracking-wider text-sm">
                     {t("firstName")}
                  </Label>
                  <Input
                    id="firstName"
                ...
                <div className="space-y-2">
                  <Label htmlFor="lastName" className="text-amber-200 font-mono uppercase tracking-wider text-sm">
                    {t("lastName")}
                  </Label>
                  <Input
                    id="lastName"
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="text-amber-200 font-mono uppercase tracking-wider text-sm">
                  {t("email")}
                </Label>
                <Input
                  id="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="username" className="text-amber-200 font-mono uppercase tracking-wider text-sm">
                  {t("username")}
                </Label>
                <Input
                  id="username"
              ...
              <div className="space-y-2">
                <Label htmlFor="phoneNumber" className="text-amber-200 font-mono uppercase tracking-wider text-sm">
                   {t("phoneNumber")}
                </Label>
                <Input
                  id="phoneNumber"
              ...
              {/* Country Selector */}
              <div className="space-y-2">
                <Label htmlFor="country" className="text-amber-200 font-mono uppercase tracking-wider text-sm">
                    {t("country")}
                </Label>
                <Popover open={showCountryDropdown} onOpenChange={setShowCountryDropdown}>
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className="w-full justify-between bg-gray-800/50 border-2 border-amber-400/30 text-white hover:bg-gray-700/50 backdrop-blur-sm focus:border-amber-400 font-mono shadow-[0_0_10px_rgba(255,191,0,0.2)]"
                      disabled={isLoading}
                    >
                  ...
                  <PopoverContent className="w-[--radix-popover-trigger-width] p-0 bg-gray-900/90 backdrop-blur-xl border-2 border-amber-400/30 text-white">
                    <Command className="bg-transparent text-white">
                      <CommandInput
                        placeholder={t("searchCountries")}
                        value={countrySearch}
                        onValueChange={setCountrySearch}
                        className="bg-gray-800/50 border-amber-400/20 text-white placeholder:text-gray-500 focus:ring-amber-400 font-mono"
                      />
                        ...
                        <CommandGroup>
                          {filteredCountries.map((country) => (
                            <CommandItem
                              ...
                              className="cursor-pointer hover:bg-amber-500/20 text-white data-[selected=true]:bg-amber-500/30 font-mono"
                            >
                              <Check
                                className={cn(
                                  "mr-2 h-4 w-4",
              ...
              {/* Language Selector */}
              <div className="space-y-2">
                <Label htmlFor="language" className="text-amber-200 font-mono uppercase tracking-wider text-sm">
                 {t("language")}
                </Label>
                          ...
                          {filteredLanguages
                            ...
                            .map((language) => (
                              <CommandItem
                                ...
                                className="cursor-pointer text-white hover:bg-amber-500/20 data-[selected=true]:bg-amber-500/30 font-mono"
                              >
                                <Check
                                  className={cn(
                                    "mr-2 h-4 w-4",
              ...
              {/* Date of Birth */}
              <div className="space-y-2">
                <Label htmlFor="dateOfBirth" className="text-amber-200 font-mono uppercase tracking-wider text-sm">
                 {t("dateOfBirth")}
                </Label>
                <Popover open={showDatePicker} onOpenChange={setShowDatePicker}>
                  <PopoverTrigger asChild>
                    <Button
                      variant={"outline"}
                      className={cn(
                        "w-full justify-start text-left font-normal bg-gray-800/50 border-2 border-amber-400/30 text-white hover:bg-gray-700/50 backdrop-blur-sm focus:border-amber-400 font-mono shadow-[0_0_10px_rgba(255,191,0,0.2)]",
                  ...
                  <PopoverContent className="w-auto p-0 bg-gray-900/90 backdrop-blur-xl border-2 border-amber-400/30 text-white">
                    <Calendar
                      mode="single"
                      ...
                      toYear={new Date().getFullYear()}
                       className="[&_td]:text-gray-200 [&_th]:text-amber-300 [&_button]:text-gray-200 [&_button]:hover:bg-amber-500/20 [&_button]:focus:bg-amber-500/20 [&_div.rdp-day_selected]:bg-amber-500 [&_div.rdp-day_selected]:text-black [&_div.rdp-day_today]:text-amber-400 [&_select]:bg-gray-800/50 [&_select]:text-white [&_select]:border-amber-400/30 [&_select]:rounded-md [&_select]:focus:ring-amber-400 font-mono"
                    />
                  </PopoverContent>
                </Popover>
              </div>
            ...
            <p className="text-center text-gray-300 mt-4 font-mono">
      ...
      <div className="flex-1 bg-gradient-to-br from-amber-900/10 to-red-900/10 backdrop-blur-sm p-8 flex items-center justify-center relative overflow-hidden">
          ...
          <div className="space-y-6">
            {t.raw("benefits").map((benefit: string, idx: number) => (
              <div key={idx} className="flex items-start space-x-3">
                ...
                <p className="text-gray-200 leading-relaxed text-lg font-mono">{benefit}</p>
              </div>
            ))}
          </div>

          <div className="grid grid-cols-1 items-center sm:grid-cols-3 gap-6 pt-8 border-t border-amber-400/30 mt-8">
            <div className="text-center">
              <p className="text-amber-300 text-sm mb-1 font-mono uppercase tracking-wider">{t("volume")}</p>
              <p className="text-3xl font-black text-amber-400 font-mono drop-shadow-[0_0_15px_rgba(255,191,0,0.6)]">$8.5B+</p>
            </div>
            <div className="text-center">
              <p className="text-amber-300 text-sm mb-1 font-mono uppercase tracking-wider">{t("traders")}</p>
              <p className="text-3xl font-black text-amber-400 font-mono drop-shadow-[0_0_15px_rgba(255,191,0,0.6)]">1M+</p>
            </div>
            <div className="text-center">
              <p className="text-amber-300 text-sm mb-1 font-mono uppercase tracking-wider">{t("countries")}</p>
              <p className="text-3xl font-black text-amber-400 font-mono drop-shadow-[0_0_15px_rgba(255,191,0,0.6)]">200+</p>
            </div>
          </div>
        </div>
      </div>
