...
export const Market: React.FC = () => {
  ...
  return (
    <section className="py-14 sm:py-20 border-b-2 container mx-auto border-gray-200 bg-gradient-to-br from-black via-gray-900 to-purple-900 min-h-screen relative overflow-hidden">
      {/* Cyberpunk Grid */}
